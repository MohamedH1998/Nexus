                  ...
                  {({ open }) => (
                    <>
                      <Disclosure.Button className="flex justify-between w-full px-4 py-2 text-sm font-medium text-left border-2 border-gray-100 rounded-lg focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                        <span className="my-2 text-xl "><i className="inline-block p-2 mb-1 mr-4 text-3xl text-gray-800 align-middle rounded-md shadow-md bg-blue-lightest"><AiFillCheckCircle/></i>Preferences</span>
                  ...
                  {({ open }) => (
                    <>
                      ...
                      <Transition
                        ...
                        <Disclosure.Panel className="pt-4 pb-2 text-sm ">
                          <div className="px-4 pt-2 ">
                          <span className="inline-block w-full px-8 py-4 my-2 text-lg text-black border-2 border-gray-100 font-semi rounded-xl bg-blue-lightest">
