        ...
        <Switch>
          ...
          >
            ...
            <InitialPreferences percentageProgress={40}>
              <Location
                previous="/preferences/avatar"
                next="/preferences/level"
                pref={pref}
                setPref={setPref}
              />
            </InitialPreferences>
          ...
          >
            ...
            <InitialPreferences percentageProgress={60}>
              <Level
                previous="/preferences/location"
                next="/preferences/jobs"
                pref={pref}
                setPref={setPref}
              />
            </InitialPreferences>
          ...
          >
            ...
            <InitialPreferences percentageProgress={80}>
              <Jobs
                previous="/preferences/level"
                next="/preferences/industries"
                pref={pref}
                setPref={setPref}
              />
            </InitialPreferences>
