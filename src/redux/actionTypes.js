...
export const RETRIEVE_PREFERENCES_START = 'RETRIEVE_PREFERENCES_START'
export const RETRIEVE_PREFERENCES_SUCCESS = 'RETRIEVE_PREFERENCES_SUCCESS'
export const RETRIEVE_PREFERENCES_FAIL = 'RETRIEVE_PREFERENCES_FAIL'

export const SET_SPECIFIC_PREFERENCE = 'SET_SPECIFIC_PREFERENCE'